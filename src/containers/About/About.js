    ...
    <div id='AboutUs' className='py-5'>
        <Container>
            <Row className='my-5'>
                ...
                <Col lg="6" className='my-3'>Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                    ...
                    Suspendisse non ultrices velit, sed maximus velit.

                    Curabitur porttitor mattis blandit. Donec non faucibus velit. Sed semper finibus quam,
                    vel congue massa fringilla eu. Ut ex quam, tempor quis eros ac, feugiat sagittis ex.
                    Maecenas mattis urna eleifend, imperdiet urna ut, convallis ex.</Col>
